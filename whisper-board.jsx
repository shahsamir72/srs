  ...
  return (
    <>
      ...
      <div style={{ minHeight: "100vh", background: "#0d0a14", color: "#f0e6ff", position: "relative", overflowX: "hidden" }}>
        ...
        {floaters.map(f => (
          <div key={f.id} style={{
            position: "fixed", left: f.x + "%", bottom: "22%",
            fontSize: "1.8rem", animation: "floatUp 1.7s ease-out forwards",
        ...
        <div style={{ position: "relative", zIndex: 1, maxWidth: 680, margin: "0 auto", padding: "0 16px 80px" }}>
          ...
          <div style={{ textAlign: "center", padding: "44px 0 28px" }}>
            ...
            <p style={{ fontFamily: "'DM Sans', sans-serif", color: "#8870aa", fontSize: "0.92rem", marginTop: 10, fontWeight: 300 }}>
              Spill the tea. Feel better. No judgment here.
            </p>
          </div>
          ...
          <div style={{
            ...
            <textarea
              ...
              placeholder="Spill anonymously... nobody will know it's you 🤫"
              rows={3}
              style={{
            ...
            >
              {submitted ? "✓ Whispered into the void!" : "Whisper it 🌙"}
            </button>
          </div>
          ...
          {showAI && (
            <div style={{
              ...
              marginBottom: 20, animation: "slideIn 0.38s ease",
                ...
                {!aiTyping && (
                  <button
                    ...
                    style={{
                      ...
                      color: "#6a5a8a", fontFamily: "'DM Sans', sans-serif",
                      fontSize: "0.73rem", cursor: "pointer", padding: 0,
                    }}
                  >
                    dismiss ×
                  </button>
            ...
            {filtered.map((post, i) => (
              <div
                ...
                style={{
                  ...
                  border: "1px solid #2d1f48", borderRadius: 18,
                  padding: "18px 20px",
              ...
              >
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
                  <span style={{
                    ...
                    background: "#3d1a6a", color: "#c090ff",
                    fontFamily: "'DM Sans', sans-serif", fontSize: "0.68rem", letterSpacing: "0.05em",
                  }}>
                    {post.tag}
                  </span>
